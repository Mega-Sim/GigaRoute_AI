(() => {
  ...
  style.textContent = `
    ...
    @media(max-width:1050px){.assessment-panel,.b2b-head{grid-template-columns:1fr}.sales-flow-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:760px){.actions{width:100%;justify-content:flex-end;flex-wrap:wrap}.language-select{min-width:118px}.platform-download{min-width:0;padding:0 12px}#free-assessment{padding:6px 0 50px}.assessment-panel,.b2b-panel{padding:22px 18px}.assessment-grid,.b2b-grid,.sales-flow-grid{grid-template-columns:1fr}.assessment-actions .btn,.b2b-actions .contact-trigger{width:100%}.sales-hint{border-radius:16px}}
  `;
