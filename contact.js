(() => {
  ...
  const copy = {
    en: {
      ...
      performance:{kicker:'Measured engine benchmark',title:'21.559× measured realtime simulation on an office laptop with 8 GB RAM.',lead:'With 1,100 Vehicles and an 18,000 moves/hour workload, a 1-hour simulation completed in 166.981 seconds with 17,018 jobs completed.',shotCaption:'Actual Auto Simulation run — click to view full size',metrics:[['21.559×','Realtime factor'],['1,100','Vehicles'],['17,018 / h','Completed jobs / simulated hour']],machineTitle:'Benchmark environment',machine:[['Environment','Office laptop PC with integrated GPU'],['CPU','11th Gen Intel Core i5-1130G7'],['RAM','8.00 GB (7.70 GB usable)'],['System','64-bit Windows · x64']],note:'Public benchmark summary as of Aug 30, 2026. Measured in mixed mode from one Release run. Performance varies with layout complexity, traffic density, simulation settings, and hardware.'},
    ...
    es: {
      ...
      performance:{kicker:'Rendimiento medido del Simulation Engine',title:'21,559× medido en un portátil de oficina con 8 GB de RAM.',lead:'Con 1.100 Vehicles y una carga de 18.000 moves/hora, una simulación de 1 hora terminó en 166,981 segundos y completó 17.018 Jobs.',shotCaption:'Captura real de Auto Simulation · haga clic para verla a tamaño completo en una nueva ventana',metrics:[['21,559×','Factor de tiempo real'],['1.100','Vehicles'],['17.018 / h','Jobs completados / hora simulada']],machineTitle:'Entorno de medición',machine:[['Entorno','Portátil de oficina con GPU integrada'],['CPU','11th Gen Intel Core i5-1130G7'],['RAM','8,00 GB (7,70 GB utilizables)'],['Sistema','Windows de 64 bits · x64']],note:'Resumen público de medición al 30 de agosto de 2026. Medido en una ejecución Release en mixed mode. El rendimiento varía según la complejidad del layout, la densidad de tráfico, la configuración y el hardware.'},
    ...
    ja: {
      ...
      performance:{kicker:'Simulation Engine 実測性能',title:'8 GB RAM搭載の事務用ノートPCで21.559倍速を実測。',lead:'1,100台のVehicle、18,000 moves/時の負荷で、1時間のシミュレーションを166.981秒で完了し、17,018 Jobを完了しました。',shotCaption:'実際のAuto Simulation実行画面 · クリックすると新しいウィンドウで原寸表示されます',metrics:[['21.559×','実測シミュレーション倍率'],['1,100','Vehicles'],['17,018 / h','シミュレーション1時間あたり完了Job']],machineTitle:'測定環境',machine:[['実行環境','内蔵GPUの事務用ノートPC'],['CPU','11th Gen Intel Core i5-1130G7'],['RAM','8.00 GB（使用可能 7.70 GB）'],['システム','64-bit Windows · x64']],note:'2026-08-30時点の公開用実測サマリーです。mixed modeの1回のRelease Runで測定しました。レイアウトの複雑度、交通密度、設定、ハードウェアにより性能は変動します。'},
