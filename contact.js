(() => {
  ...
  style.textContent = `
    ...
    @media(max-width:1050px){.performance-head,.b2b-head{grid-template-columns:1fr}.performance-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.performance-specs{grid-template-columns:repeat(2,minmax(0,1fr))}.sales-flow-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:760px){.actions{width:100%;justify-content:flex-end;flex-wrap:wrap}.language-select{min-width:118px}.platform-download{min-width:0;padding:0 12px}#engine-performance{padding:6px 0 58px}.performance-panel,.b2b-panel{padding:22px 18px}.performance-grid,.performance-specs,.b2b-grid,.sales-flow-grid{grid-template-columns:1fr}.b2b-actions .contact-trigger{width:100%}.performance-metric strong{white-space:normal}.sales-hint{border-radius:16px}}
  `;
